import{i as e}from"./preload-helper-Cs4UwXAW.js";import{t}from"./jsx-runtime-6SDZnDXc.js";import{i as n}from"./well-Cmo-Ah-N.js";import{F as r,I as i,r as a,t as o}from"./src-CKaY9Y9N.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{o(),s=t(),c={title:`Components (Draft)/Alerts`,component:r,tags:[`autodocs`],argTypes:{message:{control:`text`}}},l=({status:e=`a warning`})=>(0,s.jsxs)(s.Fragment,{children:[`This is a field-level alert with `,e,` status.`,` `,(0,s.jsx)(n,{iconRight:`external-link`,href:globalThis.location.host,label:`Link to more info`}),`.`]}),u=e=>`This is an optional explanation of the ${e} message.`,d={href:`/`,label:`This is an external link`,isExternal:!0},f={render:e=>(0,s.jsx)(r,{...e}),args:{status:`info`,message:`A Notification`}},p={...f,name:`Information with a message and an explanation`,args:{...f.args,message:`Here is the message of the notification.`,children:`This is a longer explanation to demonstrate how text wrapping is applied to more extensive alert content.`}},m={...f,name:`Information with only an explanation`,args:{children:`You can also only have an explanation in the notification.`}},h={...f,name:`Information with explanation and links`,args:{...f.args,children:`This is the explanation of the notification.`,links:[{href:`/`,label:`This is a link below the explanation`},d]}},g={...f,args:{...f.args,status:`success`,message:`11 results`,links:[d],children:(0,s.jsx)(s.Fragment,{children:u(`success`)})}},_={...f,args:{...f.args,status:`warning`,message:`No results found.`,links:[d],children:(0,s.jsx)(s.Fragment,{children:u(`warning`)})}},v={...f,args:{...f.args,status:`error`,message:`Page not found.`,links:[d],children:(0,s.jsx)(s.Fragment,{children:u(`error`)})}},y={...f,name:`In-progress`,args:{...f.args,status:`loading`,message:`The page is loading….`}},b={render:e=>(0,s.jsxs)(`div`,{className:`m-form-field`,children:[(0,s.jsx)(a,{id:e.status,name:e.status,status:e.status,value:`Input Text`,type:`text`}),(0,s.jsx)(i,{...e})]}),name:`Success (field-level)`,args:{status:`success`,message:(0,s.jsx)(l,{status:`a success`})}},x={render:e=>(0,s.jsxs)(`div`,{className:`m-form-field`,children:[(0,s.jsx)(a,{id:e.status,name:e.status,status:e.status,value:`Input Text`,type:`text`}),(0,s.jsx)(i,{...e})]}),name:`Warning (field-level)`,args:{status:`warning`,message:(0,s.jsx)(l,{status:`a warning`})}},S={render:e=>(0,s.jsxs)(`div`,{className:`m-form-field`,children:[(0,s.jsx)(a,{id:e.status,name:e.status,status:e.status,value:`Input Text`,type:`text`}),(0,s.jsx)(i,{...e})]}),name:`Error (field-level)`,args:{status:`error`,message:(0,s.jsx)(l,{status:`an error`})}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
