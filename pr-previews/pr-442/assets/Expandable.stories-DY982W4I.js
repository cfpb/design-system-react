...
`}}}},O=l.jsxs("p",{children:["Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque ipsa voluptatibus soluta nobis unde quisquam temporibus magnam debitis quidem. Ducimus ratione corporis nesciunt earum vel est quaerat blanditiis dolore ipsa? ",l.jsx("a",{href:"/?path=/story/components-expandable--default",children:"Lorem link"})]}),a={args:{header:"Expandable label",children:O}},t={args:{...a.args,header:"Expandable label",openOnLoad:!0}},s={play:async({canvasElement:B})=>{var d;const r=D(B);await c(500);const C=r.getByText(((d=t.args)==null?void 0:d.header)??"");e(C).toBeInTheDocument();const n=r.getByRole("button");e(n.getAttribute("aria-expanded")).toMatch("false");const i=r.queryByText(/lorem ipsum/gi);e(i).not.toBeVisible(),p.click(n),await c(500),e(n.getAttribute("aria-expanded")).toMatch("true"),e(i).toBeVisible(),p.click(n),await c(500),e(n.getAttribute("aria-expanded")).toMatch("false"),e(i).not.toBeVisible()},args:{...a.args,header:"Expandable label"}},o={args:{...a.args,header:"Expandable label",icon:"bank",isPadded:!0}};var u,m,b;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
}`,...(x=(g=t.parameters)==null?void 0:g.docs)==null?void 0:x.source}}};var w,E,f;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
    const waitTime = 500;
...
}`,...(f=(E=s.parameters)==null?void 0:E.docs)==null?void 0:f.source}}};var T,y,v;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    header: 'Expandable label',
    icon: 'bank',
...
}`,...(v=(y=o.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};const S=["Default","OpenOnLoad","TestExpandCollapse","PaddedExpandable"];export{a as Default,t as OpenOnLoad,o as PaddedExpandable,s as TestExpandCollapse,S as __namedExportsOrder,V as default};
