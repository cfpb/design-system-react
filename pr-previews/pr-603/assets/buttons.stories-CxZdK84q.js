import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{i as n}from"./well-Dg9pYDRn.js";import{G as r,U as i,W as a,t as o}from"./src-XndYj8ZQ.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{o(),a(),s=t(),{expect:c,fn:l,userEvent:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components (Verified)/Buttons`,component:r,tags:[`autodocs`],argTypes:{appearance:{control:`select`},size:{control:`select`},disabled:{control:`boolean`}},parameters:{docs:{description:{component:`Buttons are interactive elements that signal actions. They should be used sparingly as each additional button on a page reduces the visual prominence of a call to action. In contrast, links should lead users to another page or further information.
