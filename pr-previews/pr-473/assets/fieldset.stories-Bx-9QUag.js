import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{L as n,m as r,t as i}from"./src-CeFawuoQ.js";import{t as a}from"./checkbox-Cgu3b1Gh.js";var o,s,c,l,u,d,f,p,m,h,g,_;e((()=>{i(),o=t(),{expect:s,userEvent:c,waitFor:l,within:u}=__STORYBOOK_MODULE_TEST__,d={title:`Components (Draft)/Fieldsets`,tags:[`autodocs`],component:n,argTypes:{legend:{control:`text`},legendHelperText:{control:`text`},isInline:{control:`boolean`}},parameters:{docs:{description:{component:`
