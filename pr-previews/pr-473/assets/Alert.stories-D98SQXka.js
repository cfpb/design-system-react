import{j as e}from"./jsx-runtime-Wp9Qcrv3.js";/* empty css                */import{A as V,T as p,a as x,L as X,I as Z}from"./Well-DjykqKwW.js";import"./Checkbox-uScmMply.js";import"./Paragraph-CHJO3p8T.js";import"./TextArea-CKaCfP7D.js";import"./index-KmaxkdDD.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-DUolvyrz.js";import"./iframe-DEbAY2dl.js";import"./index-XmDEAOo_.js";const ue={title:"Components (Draft)/Alerts",component:V,tags:["autodocs"],argTypes:{message:{control:"text"}}},f=({status:s="a warning"})=>e.jsxs(e.Fragment,{children:["This is a field-level alert with ",s," status."," ",e.jsxs(X,{hasIcon:!0,href:window.location.host,children:["Link to more info ",e.jsx(Z,{name:"external-link"})]}),"."]}),h=s=>`This is an optional explanation of the ${s} message.`,g={href:"/",label:"This is an external link",isExternal:!0},a={render:s=>e.jsx(V,{...s}),args:{status:"info",message:"A Notification"}},n={...a,name:"Information with a message and an explanation",args:{...a.args,message:"Here is the message of the notification.",children:"This is a longer explanation to demonstrate how text wrapping is applied to more extensive alert content."}},r={...a,name:"Information with only an explanation",args:{children:"You can also only have an explanation in the notification."}},t={...a,name:"Information with explanation and links",args:{...a.args,children:"This is the explanation of the notification.",links:[{href:"/",label:"This is a link below the explanation"},g]}},o={...a,args:{...a.args,status:"success",message:"11 results",links:[g],children:e.jsx(e.Fragment,{children:h("success")})}},i={...a,args:{...a.args,status:"warning",message:"No results found.",links:[g],children:e.jsx(e.Fragment,{children:h("warning")})}},l={...a,args:{...a.args,status:"error",message:"Page not found.",links:[g],children:e.jsx(e.Fragment,{children:h("error")})}},m={...a,name:"In-progress",args:{...a.args,status:"loading",message:"The page is loading…."}},c={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Success (field-level)",args:{status:"success",message:e.jsx(f,{status:"a success"})}},u={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Warning (field-level)",args:{status:"warning",message:e.jsx(f,{status:"a warning"})}},d={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Error (field-level)",args:{status:"error",message:e.jsx(f,{status:"an error"})}};var I,v,T;a.parameters={...a.parameters,docs:{...(I=a.parameters)==null?void 0:I.docs,source:{originalSource:`{
