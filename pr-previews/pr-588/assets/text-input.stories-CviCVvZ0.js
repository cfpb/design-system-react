import{i as e,s as t}from"./preload-helper-Cs4UwXAW.js";import{ot as n}from"./iframe-BaYjxjT_.js";import{t as r}from"./jsx-runtime-6SDZnDXc.js";import{k as i,r as a,t as o}from"./src-TVwrqbc2.js";import{t as s}from"./icon-DEmtZsrI.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{c=t(n(),1),o(),l=r(),{expect:u,userEvent:d,within:f}=__STORYBOOK_MODULE_TEST__,p={title:`Components (Verified)/Text inputs/Text input`,tags:[`autodocs`],component:a,argTypes:{isFullWidth:{control:`boolean`},isDisabled:{control:`boolean`}}},m={args:{name:`Enabled`,id:`Enabled`,value:`Enabled`,type:`text`},play:async({canvasElement:e})=>{let t=f(e).getByRole(`textbox`);await u(t).toHaveValue(`Enabled`),await d.click(t),await u(t).toHaveFocus()}},h={args:{...m.args,name:`Hover`,id:`Hover`,value:`Hover`},render:e=>(0,l.jsx)(a,{...e,className:`hover`})},g={args:{...m.args,name:`Focus`,id:`Focus`,value:`Focus`},render:e=>(0,l.jsx)(a,{...e,className:`focus`})},_={args:{...m.args,value:`Disabled`,name:`Disabled`,id:`Disabled`,disabled:!0}},v={args:{...m.args,value:`Success`,name:`Success`,id:`Success`,status:`success`}},y={args:{...m.args,value:`Warning`,name:`Warning`,id:`Warning`,status:`warning`}},b={args:{...m.args,value:`Error`,name:`Error`,id:`Error`,status:`error`}},x={name:`Full width`,args:{...m.args,value:`Input text`,name:`fullWidth`,id:`fullWidth`,isFullWidth:!0}},S={name:`Search input`,args:{...m.args,value:``,placeholder:`Enter your search term(s)`,name:`SearchInput`,id:`SearchInput`,type:`search`,isFullWidth:!1,className:`a-text-input__full`},render:e=>{let{value:t,...n}=e,[r,o]=(0,c.useState)(t??``);return(0,l.jsx)(`form`,{onSubmit:e=>{e.preventDefault()},onReset:()=>o(``),children:(0,l.jsxs)(`div`,{className:`o-search-input`,children:[(0,l.jsxs)(`div`,{className:`o-search-input__input`,children:[(0,l.jsx)(`label`,{htmlFor:`SearchInput`,className:`o-search-input__input-label`,"aria-label":`Search for a term`,children:(0,l.jsx)(s,{name:`search`})}),(0,l.jsx)(a,{...n,value:r,onChange:e=>o(e.target.value)}),(0,l.jsx)(`button`,{type:`reset`,"aria-label":`Clear search`,title:`Clear search`,children:(0,l.jsx)(s,{name:`error`})})]}),(0,l.jsx)(i,{type:`submit`,"aria-label":`Search for term(s)`,label:`Search`})]})})}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Enabled',
    id: 'Enabled',
    value: 'Enabled',
