import{i as e}from"./preload-helper-BdFrVu1K.js";import{t}from"./jsx-runtime-f3rHp9ZU.js";import{g as n,t as r,z as i}from"./src-DWYkP6Ui.js";import{t as a}from"./checkbox-6uG6BRj9.js";var o,s,c,l,u,d,f,p,m,h,g,_;e((()=>{r(),o=t(),{expect:s,userEvent:c,waitFor:l,within:u}=__STORYBOOK_MODULE_TEST__,d={title:`Components (Draft)/Fieldsets`,tags:[`autodocs`],component:i,argTypes:{legend:{control:`text`},legendHelperText:{control:`text`},isInline:{control:`boolean`}},parameters:{docs:{description:{component:`
...
`}}}},f=`Use block helper text for instructions.`,p={name:`With checkboxes`,args:{legend:`Basic legend`,legendHelperText:f},render:e=>(0,o.jsx)(`form`,{className:`o-form`,children:(0,o.jsx)(`div`,{className:`o-form__group`,children:(0,o.jsxs)(i,{...e,children:[(0,o.jsx)(a,{id:`fieldset-checkbox-1`,name:`test_checkbox`,label:`Label`}),(0,o.jsx)(a,{id:`fieldset-checkbox-2`,name:`test_checkbox`,label:`Label`})]})})}),play:async({canvasElement:e})=>{let t=u(e).getAllByRole(`checkbox`);await l(()=>s(t[0]).not.toBeChecked()),await l(()=>s(t[1]).not.toBeChecked()),await c.click(t[0]),await l(()=>s(t[0]).toBeChecked()),await s(t[1]).not.toBeChecked(),await c.click(t[1]),await l(()=>s(t[1]).toBeChecked()),await s(t[0]).toBeChecked()}},m={name:`With radio buttons`,args:{legend:`Basic legend`,legendHelperText:f},render:e=>(0,o.jsx)(`form`,{className:`o-form`,children:(0,o.jsx)(`div`,{className:`o-form__group`,children:(0,o.jsxs)(i,{...e,children:[(0,o.jsx)(n,{id:`fieldset-radio-1`,name:`test_radio`,label:`Label`}),(0,o.jsx)(n,{id:`fieldset-radio-2`,name:`test_radio`,label:`Label`})]})})}),play:async({canvasElement:e})=>{let t=u(e).queryAllByRole(`radio`,{name:/label/i}),n=t[0],r=t[1];await l(()=>s(n).not.toBeChecked()),await l(()=>s(r).not.toBeChecked()),await c.click(n),await l(()=>s(n).toBeChecked()),await s(r).not.toBeChecked(),await c.click(r),await l(()=>s(r).toBeChecked()),await s(n).not.toBeChecked()}},h={name:`Large target area with checkboxes`,args:{legend:`Basic legend`,legendHelperText:f},render:e=>(0,o.jsx)(`form`,{className:`o-form`,children:(0,o.jsx)(`div`,{className:`o-form__group`,children:(0,o.jsxs)(i,{...e,children:[(0,o.jsx)(a,{id:`fieldset-checkbox-lg-1`,name:`test_checkbox_lg`,label:`Label`,isLarge:!0}),(0,o.jsx)(a,{id:`fieldset-checkbox-lg-2`,name:`test_checkbox_lg`,label:`Label`,isLarge:!0}),(0,o.jsx)(a,{id:`fieldset-checkbox-lg-3`,name:`test_checkbox_lg`,label:`Label`,isLarge:!0}),(0,o.jsx)(a,{id:`fieldset-checkbox-lg-4`,name:`test_checkbox_lg`,label:`Label`,isLarge:!0})]})})})},g={name:`Large target area with radio buttons`,args:{legend:`Basic legend`,legendHelperText:f},render:e=>(0,o.jsx)(`form`,{className:`o-form`,children:(0,o.jsx)(`div`,{className:`o-form__group`,children:(0,o.jsxs)(i,{...e,children:[(0,o.jsx)(n,{id:`fieldset-radio-lg-1`,name:`test_radio_lg`,label:`Label`,isLarge:!0,value:`1`}),(0,o.jsx)(n,{id:`fieldset-radio-lg-2`,name:`test_radio_lg`,label:`Label`,isLarge:!0,value:`0`}),(0,o.jsx)(n,{id:`fieldset-radio-lg-3`,name:`test_radio_lg`,label:`Label`,isLarge:!0,value:`0`}),(0,o.jsx)(n,{id:`fieldset-radio-lg-4`,name:`test_radio_lg`,label:`Label`,isLarge:!0,value:`0`})]})})})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
