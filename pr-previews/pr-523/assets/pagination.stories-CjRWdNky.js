import{j as n}from"./jsx-runtime-u17CrQMm.js";import"./iframe-CQt3-t6V.js";import{P as v,u as E}from"./text-introduction-38p0-U5E.js";import"./checkbox-9rHb_GCI.js";import"./icon-CuW7mM6B.js";import"./link-DrjLzLpS.js";import"./well-CsHPh7VD.js";import"./paragraph-COolEYhj.js";import"./secondary-nav-NTOOTsf_.js";import"./summary-WxtPLrPo.js";import"./text-area-BkHgqu7b.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BwiDlV9A.js";const u=1,h=2,_=a=>[...Array.from({length:a}).keys()].map(e=>[`A${e+u}`,`B${e+u}`]),x=a=>{const e="____PLACEHOLDER____",o=[];let t=JSON.stringify(a,(i,s)=>typeof s=="function"?(o.push(s),e):s,h);return t=t.replaceAll(new RegExp(`"${e}"`,"g"),()=>o.shift()),t},{expect:P,fn:m,userEvent:A,within:R}=__STORYBOOK_MODULE_TEST__,$={title:"Components (Verified)/Pagination",tags:["autodocs"],component:v},T=1,b=20,d=40,r={name:"Default pagination",args:{page:b,pageCount:d,onClickPrevious:m(),onClickNext:m()},play:async({canvasElement:a,args:e})=>{const o=R(a),t=o.getByRole("button",{name:/next/i}),i=o.getByRole("button",{name:/previous/i});await A.click(t),await P(e.onClickNext).toHaveBeenCalledTimes(1),await A.click(i),await P(e.onClickPrevious).toHaveBeenCalledTimes(1)}},p={name:"Previous button disabled on first page",args:{page:T,pageCount:d}},c={name:"Next button disabled on last page",args:{page:d,pageCount:d}},g={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const t=_(6),i={rows:t,perPage:2,startPage:1},[s,l]=E(i);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{children:[n.jsx("h4",{children:"Calling the hook"}),n.jsxs("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: 1,
`,`	perPage: 2,
`,`	rows: ${JSON.stringify(t)}
`,"});"]})]}),n.jsx("br",{}),n.jsxs("div",{children:[n.jsxs("h4",{children:["Output: ",n.jsx("code",{children:"visibleRows"})]}),n.jsx("pre",{children:JSON.stringify(s)})]}),n.jsx("br",{}),n.jsxs("div",{children:[n.jsxs("h4",{children:["Output: ",n.jsx("code",{children:"paginationProperties"})]}),n.jsx("pre",{children:x(l)})]}),n.jsx("br",{}),n.jsx(v,{...l})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...g.parameters?.docs?.source}}};const U=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{r as Base,c as NextDisabledAtMaxPage,p as PreviousDisabledAtMinPage,g as UsePagination,U as __namedExportsOrder,$ as default};
