...
Example usage:
 ...
 \\<DSRContext value={{LinkComponent: YourRouterLinkComponent}} >
   App content
 \\</DSRContext>`,...S.parameters?.docs?.description}}},C=[`Inline`,`Standalone`,`WithIcon`,`Listlink`,`Destructive`,`LinkWithCustomLinkComponent`]})))()}w();export{b as Destructive,g as Inline,S as LinkWithCustomLinkComponent,y as Listlink,_ as Standalone,v as WithIcon,C as __namedExportsOrder,m as default};