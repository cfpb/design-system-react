import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-C5txrvMP.js";import{a,b as d,c as k}from"./well-C2_GXaSY.js";import"./checkbox-D1W6yVVa.js";import"./paragraph-sWiGmZ3V.js";import"./text-area-AdZghSAW.js";import"./preload-helper-PPVm8Dsz.js";import"./index-D9x_oo6z.js";const{expect:b,fn:y,userEvent:h,within:B}=__STORYBOOK_MODULE_TEST__,G={title:"Components (Verified)/Buttons",component:a,tags:["autodocs"],argTypes:{appearance:{control:"select"},size:{control:"select"},disabled:{control:"boolean"}},parameters:{docs:{description:{component:`Buttons are interactive elements that signal actions. They should be used sparingly as each additional button on a page reduces the visual prominence of a call to action. In contrast, links should lead users to another page or further information.
...
}`,...m.parameters?.docs?.source}}};const _=["Primary","Secondary","Disabled","Destructive","StaticIconButtons","AnimatedIconButtons","ButtonsGroup","FullWidthOnSmallScreens","ButtonLink"];export{l as AnimatedIconButtons,m as ButtonLink,u as ButtonsGroup,i as Destructive,s as Disabled,p as FullWidthOnSmallScreens,t as Primary,o as Secondary,c as StaticIconButtons,_ as __namedExportsOrder,G as default};
