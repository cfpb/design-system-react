import{j as n}from"./jsx-runtime-u17CrQMm.js";import"./iframe-PV1NxEpq.js";import{U as m,V as l}from"./well-Br87P2e8.js";import"./checkbox-Bj_QToN3.js";import"./paragraph-hOzKBsgF.js";import"./text-area-CI2YzesK.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BSKF1xR6.js";const u=1,A=2,h=s=>[...Array.from({length:s}).keys()].map(e=>[`A${e+u}`,`B${e+u}`]),E=s=>{const e="____PLACEHOLDER____",c=[];let t=JSON.stringify(s,(d,a)=>typeof a=="function"?(c.push(a),e):a,A);return t=t.replaceAll(new RegExp(`"${e}"`,"g"),()=>c.shift()),t},w={title:"Components (Verified)/Pagination",tags:["autodocs"],component:m},_=1,R=20,g=40,o={name:"Default pagination",args:{page:R,pageCount:g}},r={name:"Previous button disabled on first page",args:{page:_,pageCount:g}},i={name:"Next button disabled on last page",args:{page:g,pageCount:g}},p={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const t=h(6),d={rows:t,perPage:2,startPage:1},[a,P]=l(d);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{children:[n.jsx("h4",{children:"Calling the hook"}),n.jsxs("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: 1,
`,`	perPage: 2,
...
}`,...p.parameters?.docs?.source}}};const S=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{o as Base,i as NextDisabledAtMaxPage,r as PreviousDisabledAtMinPage,p as UsePagination,S as __namedExportsOrder,w as default};
