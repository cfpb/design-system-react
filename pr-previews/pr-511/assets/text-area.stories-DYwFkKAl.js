import{T as i}from"./text-area-Bi44PmeA.js";import"./jsx-runtime-u17CrQMm.js";import"./index-Betm_zKu.js";import"./iframe-DgvytpVM.js";import"./preload-helper-PPVm8Dsz.js";const{expect:m,userEvent:u,within:p}=__STORYBOOK_MODULE_TEST__,x={title:"Components (Verified)/Text inputs/Text area",tags:["autodocs"],component:i,argTypes:{isFullWidth:{control:"boolean"},isDisabled:{control:"boolean"}}},e={args:{id:"Enabled",placeholder:"Enabled",name:"Enabled"},play:async({canvasElement:d})=>{const l=p(d).getByRole("textbox");await u.type(l,"Sample comment"),m(l).toHaveValue("Sample comment")}},a={args:{id:"Hover",placeholder:"Hover",name:"Hover",className:"hover"}},r={args:{id:"Focus",placeholder:"Focus",name:"Focus",className:"focus"}},s={args:{id:"Disabled",placeholder:"Disabled",name:"Disabled",isDisabled:!0}},n={args:{id:"Success",placeholder:"Success",name:"Success",status:"success"}},o={args:{id:"Warning",placeholder:"Warning",name:"Warning",status:"warning"}},c={args:{id:"Error",placeholder:"Error",name:"Error",status:"error"}},t={args:{id:"Full width",placeholder:"Full width",name:"Full width",isFullWidth:!0}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    id: 'Enabled',
    placeholder: 'Enabled',
    name: 'Enabled'
