import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-CjmU657T.js";import{d as o,y as i,c as d}from"./well-Bq-kdvqi.js";import"./checkbox-DPpa3mix.js";import"./paragraph-DZ2HPfJ8.js";import"./text-area-DV9wu7yz.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CsC-23Tg.js";const f={title:"Components (Draft)/Lists",component:o,argTypes:{},tags:["autodocs"],parameters:{docs:{description:{component:`
...
`}}}},r={name:"Unordered",args:{children:e.jsxs(e.Fragment,{children:[e.jsx(i,{children:"List item 1"}),e.jsx(i,{children:"List item 2"}),e.jsx(i,{children:"List item 3"})]})}},s={name:"Ordered",args:{...r.args,isOrdered:!0}},t={name:"Unstyled",args:{...r.args,isUnstyled:!0}},n={name:"Horizontal",args:{...r.args,isHorizontal:!0}},a={name:"Link",args:{isLinks:!0,children:e.jsxs(e.Fragment,{children:["In the "," "," component each list item is a standalone link, which converts to a touch-friendly link with a large tap area at smaller screen widths.",e.jsx(d,{label:"list link",href:"./?path=/docs/components-verified-links--listlink"})," ","page."]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  args: {
    ...
    children: <>
        ...
        <Link label='list link' href='./?path=/docs/components-verified-links--listlink' />{' '}
        page.
      </>
  }
