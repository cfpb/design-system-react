import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-CWHGkrjl.js";import{C as n,S as r,t as i,w as a}from"./src-C3v4BQRk.js";async function o(e){return new Promise(t=>{setTimeout(t,e)})}var s=e((()=>{try{o.displayName=`sleep`,o.__docgenInfo={description:``,displayName:`sleep`,props:{}}}catch{}})),c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{i(),s(),n(),c=t(),{expect:l,userEvent:u,waitFor:d,within:f}=__STORYBOOK_MODULE_TEST__,p={title:`Components (Verified)/Expandables`,component:a,tags:[`autodocs`],parameters:{docs:{description:{component:`
