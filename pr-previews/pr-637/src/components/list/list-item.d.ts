import { JSX, HTMLProps, ReactElement } from '../../../node_modules/react';
export default function ListItem({ children, className, ...properties }: HTMLProps<HTMLLIElement>): JSX.Element;
