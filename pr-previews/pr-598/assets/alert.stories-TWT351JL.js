import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{et as n,i as r,nt as i,t as a}from"./src-DTHeZbMi.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{a(),o=t(),s={title:`Components (Draft)/Alerts`,component:n,tags:[`autodocs`],argTypes:{message:{control:`text`}}},c=({status:e=`a warning`})=>(0,o.jsxs)(o.Fragment,{children:[`This is a field-level alert with `,e,` status.`]}),l=e=>`This is an optional explanation of the ${e}.`,u={href:`/`,label:`This is an external link`,isExternal:!0},d={render:e=>(0,o.jsx)(n,{...e}),args:{status:`info`,message:`Information alert`}},f={...d,name:`Information with a message and an explanation`,args:{...d.args,children:`You can also add an explanation to the alert.`}},p={...d,name:`Information with only an explanation`,args:{children:`You can also only have an explanation in the notification.`}},m={...d,args:{...d.args,children:`This is the explanation of the alert.`,links:[{href:`/`,label:`This is a link below the explanation`},u]}},h={...d,args:{...d.args,status:`success`,message:`11 results`,links:[u],children:(0,o.jsx)(o.Fragment,{children:l(`success message`)})}},g={...d,args:{...d.args,status:`warning`,message:`No results found`,links:[u],children:(0,o.jsx)(o.Fragment,{children:l(`warning`)})}},_={...d,args:{...d.args,status:`error`,message:`Page not found`,links:[u],children:(0,o.jsx)(o.Fragment,{children:l(`error`)})}},v={...d,name:`In-progress`,args:{...d.args,status:`loading`,message:`The page is loading….`}},y={render:e=>(0,o.jsxs)(`div`,{className:`m-form-field`,children:[(0,o.jsx)(r,{id:e.status,name:e.status,status:e.status,value:`Input text`,type:`text`}),(0,o.jsx)(i,{...e})]}),name:`Success (field-level)`,args:{status:`success`,message:(0,o.jsx)(c,{status:`a success`})}},b={render:e=>(0,o.jsxs)(`div`,{className:`m-form-field`,children:[(0,o.jsx)(r,{id:e.status,name:e.status,status:e.status,value:`Input text`,type:`text`}),(0,o.jsx)(i,{...e})]}),name:`Warning (field-level)`,args:{status:`warning`,message:(0,o.jsx)(c,{status:`a warning`})}},x={render:e=>(0,o.jsxs)(`div`,{className:`m-form-field`,children:[(0,o.jsx)(r,{id:e.status,name:e.status,status:e.status,value:`Input text`,type:`text`}),(0,o.jsx)(i,{...e})]}),name:`Error (field-level)`,args:{status:`error`,message:(0,o.jsx)(c,{status:`an error`})}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
