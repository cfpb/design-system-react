import{i as e}from"./preload-helper-xPQekRTU.js";import{t}from"./jsx-runtime-CaZkqeYb.js";import{G as n,U as r,W as i,t as a}from"./src-DJQZVFum.js";import{i as o}from"./well-gUkNJ9T7.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;e((()=>{a(),i(),s=t(),{expect:c,fn:l,userEvent:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components (Verified)/Buttons`,component:n,tags:[`autodocs`],argTypes:{appearance:{control:`select`},size:{control:`select`},disabled:{control:`boolean`}},parameters:{docs:{description:{component:`Buttons are interactive elements that signal actions. They should be used sparingly as each additional button on a page reduces the visual prominence of a call to action. In contrast, links should lead users to another page or further information.

Source: <a href="https://cfpb.github.io/design-system/components/buttons" target="_blank">https://cfpb.github.io/design-system/components/buttons</a>`}}}},p={args:{label:`Primary`,appearance:`primary`,size:`default`,disabled:!1,isLink:!1,iconLeft:void 0,iconRight:void 0,onClick:l()},play:async({canvasElement:e,args:t})=>{let n=d(e).getByRole(`button`,{name:/primary/i});await u.click(n),await c(t.onClick).toHaveBeenCalledTimes(1)}},m={args:{...p.args,label:`Secondary`,appearance:`secondary`}},h={args:{...p.args,label:`Disabled`,disabled:!0,onClick:l()},play:async({canvasElement:e,args:t})=>{let n=d(e).getByRole(`button`,{name:/disabled/i});await u.click(n),await c(n).toBeDisabled(),await c(t.onClick).not.toHaveBeenCalled()}},g={args:{...p.args,label:`Destructive`,appearance:`warning`}},_={name:`With icon`,args:{...p.args},render:e=>(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)(r,{children:[(0,s.jsx)(n,{...e,label:`Go back`,iconLeft:`left`,appearance:`secondary`}),(0,s.jsx)(n,{...e,label:`Continue`,iconRight:`right`,appearance:`secondary`})]}),(0,s.jsx)(`br`,{}),(0,s.jsx)(n,{iconRight:`upload`,label:`Upload file`})]})},v={name:`With animated icon`,args:{...p.args,label:`Submit your complaint`},render:e=>(0,s.jsx)(n,{...e,iconRight:`updating`})},y={name:`Button group`,render:e=>(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)(r,{children:[(0,s.jsx)(n,{...e,appearance:`secondary`,label:`Go back`,iconLeft:`left`},`Go back`),(0,s.jsx)(n,{...e,label:`Continue`,iconRight:`right`},`Continue`)]}),(0,s.jsx)(`br`,{}),(0,s.jsxs)(r,{children:[(0,s.jsx)(n,{...e,label:`Submit`},`Submit`),(0,s.jsx)(n,{appearance:`warning`,isLink:!0,...e,label:`Clear form`},`Clear form`)]})]})},b={name:`Full-width (on x-small screens)`,args:{...p.args,label:`Full-width`,appearance:`primary`,size:`full`}},x={name:`Button link`,render:e=>(0,s.jsxs)(r,{children:[(0,s.jsx)(o,{isButton:!0,href:`/`,label:`Link styled as a button`,iconRight:`download`}),(0,s.jsx)(n,{isLink:!0,...e,label:`Button styled as a link`,iconRight:`download`},`1`)]})},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Primary',
    appearance: 'primary',
    size: 'default',
