import{j as n}from"./jsx-runtime-Wp9Qcrv3.js";/* empty css                */import{Y as G,Z as O}from"./Well-Bf3XISgu.js";import"./Checkbox-uScmMply.js";import"./Paragraph-CHJO3p8T.js";import"./TextArea-ZDMBHX8g.js";import"./index-KmaxkdDD.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./index-DUolvyrz.js";import"./iframe-yCEJCKMN.js";import"./index-XmDEAOo_.js";const u=1,j=2,w=s=>[...Array.from({length:s}).keys()].map(e=>[`A${e+u}`,`B${e+u}`]),S=s=>{const e="____PLACEHOLDER____",c=[];let t=JSON.stringify(s,(d,a)=>typeof a=="function"?(c.push(a),e):a,j);return t=t.replaceAll(new RegExp(`"${e}"`,"g"),()=>c.shift()),t},B={title:"Components (Verified)/Pagination",tags:["autodocs"],component:G},N=1,y=20,g=40,o={name:"Default pagination",args:{page:y,pageCount:g}},r={name:"Previous button disabled on first page",args:{page:N,pageCount:g}},i={name:"Next button disabled on last page",args:{page:g,pageCount:g}},p={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const t=w(6),d={rows:t,perPage:2,startPage:1},[a,P]=O(d);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{children:[n.jsx("h4",{children:"Calling the hook"}),n.jsxs("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: 1,
`,`	perPage: 2,
...
}`,...(v=(f=p.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};const F=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{o as Base,i as NextDisabledAtMaxPage,r as PreviousDisabledAtMinPage,p as UsePagination,F as __namedExportsOrder,B as default};
