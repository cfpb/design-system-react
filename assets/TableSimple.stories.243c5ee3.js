/* empty css                */import{b as A}from"./Well.28195bda.js";import"./Dropdown.d311ac30.js";import"./Checkbox.fe2d0150.js";import"./ExpandableGroup.5ef38df2.js";import"./Icon.ca3ea072.js";import{a as o,F as n,j as t}from"./jsx-runtime.54133100.js";import"./TextIntroduction.ff1fa05f.js";import"./Paragraph.878bd808.js";import"./index.cfa9e344.js";import"./isNativeReflectConstruct.97850bd2.js";import"./index.a2b6e612.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.987172cc.js";import"../sb-preview/runtime.js";const O={title:"Components (Draft)/Tables/Simple",component:A,parameters:{docs:{description:{component:`
### CFPB DS - TableSimple component

Source: https://cfpb.github.io/design-system/components/tables
`}}}},e={args:{caption:o(n,{children:["This is the"," ",t("a",{href:"https://cfpb.github.io/design-system/components/tables#standard-table-1",children:"default style"})," ","at the large screen breakpoint. Tables are not responsive by default;"]}),columns:["Column 1 header","Column 2 header","Column 3 header","Column 4 header"],rows:[["Row 1, Column 1","Row 1, Column 2","Row 1, Column 3","Row 1, Column 4"],["Row 2, Column 1","Row 2, Column 2","Row 2, Column 3","Row 2, Column 4"],["Row 3, Column 1","Row 3, Column 2","Row 3, Column 3","Row 3, Column 4"]]}},s={args:{...e.args,caption:o(n,{children:["Use a"," ",t("a",{href:"https://cfpb.github.io/design-system/components/tables#responsive-stacked-table",children:"Responsive stacked table"})," ","to stack table information on smaller screens and keep the information legible."]}),isResponsive:!0}},a={args:{columns:["Employee name","Phone number","Email address"],rows:[["Andrew Able","(202) XXX-XXXX","aable@example.com"],["Betsy Bort","(202) XXX-XXXX","bbort@example.com"],["Charles Clark","(202) XXX-XXXX","cclark@example.com"]],caption:o(n,{children:["The"," ",t("a",{href:"https://cfpb.github.io/design-system/components/tables#responsive-stacked-table-with-header-directory-tables",children:"directory table"})," ","is a variation of the stacked table. At the small screen breakpoint, the directory table pattern uses first column data (employee name, for instance) as a way to group and label stacks of rows. ."]}),isDirectory:!0}},r={args:{...e.args,caption:o(n,{children:["Use a table with"," ",t("a",{href:"https://cfpb.github.io/design-system/components/tables#responsive-table-with-horizontal-scroll",children:"horizontal scroll"})," ","when the data you\u2019re presenting has more columns than will fit comfortably on the screen, and you want to ensure all information can be accessed in its original tabular structure, even on smaller screens."]}),isScrollableHorizontal:!0}},l={args:{...e.args,caption:o(n,{children:[t("a",{href:"https://cfpb.github.io/design-system/components/tables#striped-table",children:"Striping"})," ","is useful to help the eye track across table rows. Use striping for tables that have more than five columns, or for tables with rows that are difficult to follow across the full width of the table."]}),isStriped:!0}},T=[{header:"Col 1",width:30},"Col 2","Col 3",{header:"Right Aligned",width:40,alignRight:!0}],i={args:{...e.args,columns:T,caption:o(n,{children:[t("a",{href:"https://cfpb.github.io/design-system/components/tables#right-aligned-table",children:"Right-align columns"})," ","of numbers when they\u2019re quantities (counts, dollar amounts, percentages) or ordinals (ranks, item numbers). Use the .o-table_cell__right-align class on a td. ",t("br",{}),t("br",{}),"Left-align columns of numbers when they\u2019re nominal (ZIP codes, room numbers) or non-numeric values (names, phrases)."]})}};var c,m,p;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    caption: <>
        This is the{' '}
...
}`,...(x=(v=i.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};const G=["Standard","Responsive","Directory","HorizontalScroll","Striped","RightAligned"];export{a as Directory,r as HorizontalScroll,s as Responsive,i as RightAligned,e as Standard,l as Striped,G as __namedExportsOrder,O as default};
//# sourceMappingURL=TableSimple.stories.243c5ee3.js.map
