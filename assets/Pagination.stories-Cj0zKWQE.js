import{j as n}from"./jsx-runtime-u17CrQMm.js";/* empty css                */import{Y as m,Z as l}from"./Well-B0-4zp3X.js";import"./Checkbox-bkZbx_rd.js";import"./Paragraph-DvazyV92.js";import"./TextArea-DebaAmxd.js";import"./index-6tNKdD3S.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BAD8l0rO.js";import"./iframe-DMJy3jJj.js";const u=1,A=2,h=s=>[...Array.from({length:s}).keys()].map(e=>[`A${e+u}`,`B${e+u}`]),E=s=>{const e="____PLACEHOLDER____",c=[];let t=JSON.stringify(s,(d,a)=>typeof a=="function"?(c.push(a),e):a,A);return t=t.replaceAll(new RegExp(`"${e}"`,"g"),()=>c.shift()),t},N={title:"Components (Verified)/Pagination",tags:["autodocs"],component:m},_=1,R=20,g=40,o={name:"Default pagination",args:{page:R,pageCount:g}},r={name:"Previous button disabled on first page",args:{page:_,pageCount:g}},i={name:"Next button disabled on last page",args:{page:g,pageCount:g}},p={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const t=h(6),d={rows:t,perPage:2,startPage:1},[a,P]=l(d);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{children:[n.jsx("h4",{children:"Calling the hook"}),n.jsxs("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: 1,
`,`	perPage: 2,
...
}`,...p.parameters?.docs?.source}}};const y=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{o as Base,i as NextDisabledAtMaxPage,r as PreviousDisabledAtMinPage,p as UsePagination,y as __namedExportsOrder,N as default};
