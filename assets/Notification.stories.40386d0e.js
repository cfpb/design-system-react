import{c as O}from"./index.cfa9e344.js";import{I as F}from"./Icon.d0366cc7.js";import{j as a,a as f,r as R}from"./jsx-runtime.556016cd.js";import"./iframe.252b8116.js";import"../sb-preview/runtime.mjs";import"./_commonjsHelpers.712cc82f.js";const g=({href:n,label:p,isExternal:u})=>a("li",{className:"m-list_item",children:f("a",{className:"m-list_link",href:n,children:[p," ",u&&a(F,{name:"external-link"})]})});try{g.displayName="NotificationLink",g.__docgenInfo={description:"",displayName:"NotificationLink",props:{href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},isExternal:{defaultValue:null,description:"",name:"isExternal",required:!1,type:{name:"boolean"}}}}}catch{}const m=({children:n,className:p,headingLevel:u="h4",links:d,message:h,type:r="info",...Y})=>{const $=O("m-notification","m-notification__visible",{"m-notification__success":r==="success","m-notification__warning":r==="warning","m-notification__error":r==="error","m-notification__info":r==="info"},p);return f("div",{className:$,...Y,children:[a(F,{...z[r]||{}}),f("div",{className:"m-notification_content",children:[h?a("p",{className:`${u} m-notification_message`,children:h}):null,n?a("p",{className:"m-notification_explanation",children:n}):null,d&&d.length>0?a("ul",{className:"m-list m-list__links",children:d.map(_=>R.exports.createElement(g,{..._,key:_.href}))}):null]})]})},z={error:{name:"error",withBg:!0},info:{name:"information",withBg:!0},loading:{name:"updating",withBg:!1},success:{name:"approved",withBg:!0},warning:{name:"warning",withBg:!0}};try{m.displayName="Notification",m.__docgenInfo={description:`CFPB DS Notification

https://cfpb.github.io/design-system/components/notifications`,displayName:"Notification",props:{type:{defaultValue:{value:"info"},description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"warning"'},{value:'"error"'},{value:'"success"'},{value:'"info"'},{value:'"loading"'}]}},message:{defaultValue:null,description:"",name:"message",required:!1,type:{name:"ReactNode"}},headingLevel:{defaultValue:{value:"h4"},description:"",name:"headingLevel",required:!1,type:{name:"enum",value:[{value:'"h1"'},{value:'"h2"'},{value:'"h3"'},{value:'"h4"'},{value:'"h5"'},{value:'"h6"'}]}},links:{defaultValue:null,description:"",name:"links",required:!1,type:{name:"NotificationLinkProperties[]"}}}}}catch{}const U={component:m,argTypes:{message:{control:"text"}},parameters:{docs:{description:{component:`
...
}`,...(x=(N=e.parameters)==null?void 0:N.docs)==null?void 0:x.source}}};var I,v,k;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...Information,
  args: {
    ...Information.args,
    children: 'You can also add an explanation to the notification.'
  }
}`,...(k=(v=i.parameters)==null?void 0:v.docs)==null?void 0:k.source}}};var b,w,S;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...Information,
  args: {
    ...Information.args,
...
//# sourceMappingURL=Notification.stories.40386d0e.js.map
