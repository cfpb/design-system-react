/* empty css                */import{P as w,u as S}from"./Well.e4dc9050.js";import"./Dropdown.51036178.js";import"./Checkbox.adabeb2b.js";import"./ExpandableGroup.54048ccb.js";import"./Icon.f601679c.js";import{a as e,F as N,j as n}from"./jsx-runtime.54133100.js";import"./Paragraph.878bd808.js";import"./index.cfa9e344.js";import"./isNativeReflectConstruct.97850bd2.js";import"./index.a2b6e612.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.034b3e74.js";import"../sb-preview/runtime.js";const m=1,y=2,C=r=>[...Array.from({length:r}).keys()].map(t=>[`A${t+m}`,`B${t+m}`]),D=r=>{const t="____PLACEHOLDER____",d=[];let a=JSON.stringify(r,(P,o)=>typeof o=="function"?(d.push(o),t):o,y);return a=a.replaceAll(new RegExp(`"${t}"`,"g"),()=>d.shift()),a},z={title:"Components (Verified)/Pagination",tags:["autodocs"],component:w},x=1,M=20,c=40,s={name:"Default pagination",args:{page:M,pageCount:c}},i={name:"Previous button disabled on first page",args:{page:x,pageCount:c}},p={name:"Next button disabled on last page",args:{page:c,pageCount:c}},g={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const a=C(6),P={rows:a,perPage:2,startPage:1},[o,u]=S(P);return e(N,{children:[e("div",{children:[n("h4",{children:"Calling the hook"}),e("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: ${1},
`,`	perPage: ${2},
`,`	rows: ${JSON.stringify(a)}
`,"});"]})]}),n("br",{}),e("div",{children:[e("h4",{children:["Output: ",n("code",{children:"visibleRows"})]}),n("pre",{children:JSON.stringify(o)})]}),n("br",{}),e("div",{children:[e("h4",{children:["Output: ",n("code",{children:"paginationProperties"})]}),n("pre",{children:D(u)})]}),n("br",{}),n(w,{...u})]})}};var l,A,h;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(O=(G=g.parameters)==null?void 0:G.docs)==null?void 0:O.source}}};const K=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{s as Base,p as NextDisabledAtMaxPage,i as PreviousDisabledAtMinPage,g as UsePagination,K as __namedExportsOrder,z as default};
//# sourceMappingURL=Pagination.stories.7088fe19.js.map
