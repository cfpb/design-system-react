import{D,M as t,B as W}from"./Dropdown.7720a5d3.js";import{j as M,a as f,F as re}from"./jsx-runtime.54133100.js";import"./extends.cc011e2f.js";import"./isNativeReflectConstruct.c66bbbb3.js";import"./index.a2b6e612.js";import"./_commonjsHelpers.712cc82f.js";import"./index.cfa9e344.js";import"./Checkbox.fe2d0150.js";import"./Icon.188dacf8.js";import"./iframe.19dad518.js";import"../sb-preview/runtime.js";const{useArgs:te,useState:oe}=__STORYBOOK_MODULE_CLIENT_API__,Me={title:"Components (Draft)/Dropdowns",component:D,parameters:{docs:{description:{component:`Dropdowns allow the user to choose from a finite list of options. They are not always the best choice from a usability perspective; see the <a href='https://cfpb.github.io/design-system/components/dropdowns-and-multiselects#use-cases'>use cases documentation</a> for more details.

Source: <a href='https://cfpb.github.io/design-system/components/dropdowns-and-multiselects' target='_blank'>https://cfpb.github.io/design-system/components/dropdowns-and-multiselects</a>`}}}},le=-1;function r({...e}){const[w,l]=oe(e.value),[,s]=te();return M(D,{...e,value:w,onSelect:n=>{l(n),s({value:n})}})}const o={render:e=>r(e),name:"Default dropdown",args:{label:"Default Dropdown",id:"dropdown",options:t,value:[t[0]]}},a={render:e=>r(e),name:"With error",args:{...o.args,id:"WithError",error:!0,label:"With Error"}},i={render:e=>r(e),name:"With default value",args:{...o.args,id:"WithDefaultValue",value:t.at(le),label:"With Default Value"}},u={render:e=>r(e),args:{...o.args,id:"Disabled",label:"Disabled",isDisabled:!0}},c={render:e=>r(e),name:"Multi-select",args:{...o.args,options:[...t],id:"MultiSelect",isMulti:!0,label:"Multi-select"}},p={render:e=>r(e),name:"Multi-select with default value (and pills above)",args:{...o.args,options:[...t],value:[t[0]],id:"MultiSelectWithDefaultValue",isMulti:!0,label:"Multi-select with default value (and pills above)"}},d={render:e=>r(e),name:"Multi-select with checkboxes",args:{...o.args,options:[...t],value:[t[0]],id:"MultiSelectWithCheckboxes",isMulti:!0,label:"Multi-select with checkboxes",pillAlign:"bottom",withCheckbox:!0}},m={render:e=>r(e),name:"Multi-select with pills bottom-aligned",args:{...o.args,options:[...t],value:[t[0]],id:"MultiSelectWithPillsAlignedBottom",isMulti:!0,label:"Multi-select with pills bottom-aligned",pillAlign:"bottom"}},h={render:e=>r(e),name:"Multi-select with checkboxes, without pills",args:{...o.args,options:[...t],value:[t[0]],id:"MultiSelectWithCheckboxesWithoutPills",isMulti:!0,label:"Multi-select with checkboxes, without pills",pillAlign:"hide",withCheckbox:!0}},g={render:e=>r(e),name:"Multi-select with checkboxes, without bottom clear all button",args:{...o.args,options:[...t],value:[t[0]],id:"MultiSelectWithCheckboxesWithoutClearAllButton",isMulti:!0,label:"Multi-select with checkboxes, without clear all button",pillAlign:"bottom",withCheckbox:!0,showClearAllSelectedButton:!1}};function se({...e}){const[w,l]=oe(e.value),[,s]=te();return f(re,{children:[f("div",{className:"m-btn-group u-mb30",children:[M(W,{label:"Add all options",onClick:()=>{l([...t]),s({value:[...t]})}}),M(W,{label:"Clear all options",appearance:"warning",onClick:()=>{l([]),s({value:[]})}})]}),M(D,{...e,value:w,showClearAllSelectedButton:!1,onSelect:n=>{l(n),s({value:n})}})]})}const b={name:"As a controlled component",render:e=>se(e),args:{...o.args,options:[...t],value:[t[0]],id:"AsAControlledComponent",isMulti:!0,label:"As a controlled component",pillAlign:"bottom"}};var k,S,A;o.parameters={...o.parameters,docs:{...(k=o.parameters)==null?void 0:k.docs,source:{originalSource:`{
