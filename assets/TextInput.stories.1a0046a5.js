import{j as e}from"./index.7eca609e.js";/* empty css                */import{T as s}from"./Well.d6059d44.js";import{B as Q}from"./Dropdown.cfcca19d.js";import"./Checkbox.1213d1d0.js";import"./ExpandableGroup.978b7168.js";import{I as P}from"./Icon.bb871e55.js";import"./Paragraph.9304145b.js";import"./index.ca1bfdbe.js";import"./_commonjsHelpers.712cc82f.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm.1960f945.js";import"./index.f108a8f5.js";import"./iframe.1756ab7b.js";import"../sb-preview/runtime.js";const ce={title:"Components (Verified)/Text inputs",tags:["autodocs"],component:s,argTypes:{isFullWidth:{control:"boolean"},isDisabled:{control:"boolean"}}},n={args:{name:"Enabled",id:"Enabled",value:"Enabled",type:"text"}},a={args:{...n.args,name:"Hover",id:"Hover",value:"Hover"},render:t=>e.exports.jsx(s,{...t,className:"hover"})},r={args:{...n.args,name:"Focus",id:"Focus",value:"Focus"},render:t=>e.exports.jsx(s,{...t,className:"focus"})},o={args:{...n.args,value:"Disabled",name:"Disabled",id:"Disabled",disabled:!0}},i={args:{...n.args,value:"Success",name:"Success",id:"Success",status:"success"}},u={args:{...n.args,value:"Warning",name:"Warning",id:"Warning",status:"warning"}},c={args:{...n.args,value:"Error",name:"Error",id:"Error",status:"error"}},d={name:"Full width",args:{...n.args,value:"Input text",name:"fullWidth",id:"fullWidth",isFullWidth:!0}},m={name:"With button",args:{...n.args,name:"withButton",id:"withButton",value:""},render:t=>e.exports.jsxs("div",{className:"o-form__input-w-btn",children:[e.exports.jsx("div",{className:"o-form__input-w-btn_input-container",children:e.exports.jsx(s,{...t})}),e.exports.jsx("div",{className:"o-form__input-w-btn_btn-container",children:e.exports.jsx(Q,{label:"Search"})})]})},l={name:"Button inside",args:{...n.args,value:"This is some really long text to make sure that the button doesn't overlap the content in such a way that this input becomes unusable.",name:"ButtonInside",id:"ButtonInside"},render:t=>e.exports.jsxs("div",{className:"m-btn-inside-input",children:[e.exports.jsx(s,{...t}),e.exports.jsx("button",{className:"a-btn a-btn__link",children:e.exports.jsx(P,{name:"error"})})]})},p={name:"Button inside (with button)",args:{...n.args,value:"This is some really long text to make sure that the button doesn't overlap the content in such a way that this input becomes unusable.",name:"ButtonInsideButton",id:"ButtonInsideButton"},render:t=>e.exports.jsxs("div",{className:"o-form__input-w-btn",children:[e.exports.jsx("div",{className:"o-form__input-w-btn_input-container",children:e.exports.jsxs("div",{className:"m-btn-inside-input",children:[e.exports.jsx(s,{...t}),e.exports.jsx("button",{className:"a-btn a-btn__link",children:e.exports.jsx(P,{name:"error"})})]})}),e.exports.jsx("div",{className:"o-form__input-w-btn_btn-container",children:e.exports.jsx("button",{className:"a-btn",children:"Search"})})]})};var b,g,h;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    name: 'Enabled',
    id: 'Enabled',
    value: 'Enabled',
...
}`,...(j=(S=i.parameters)==null?void 0:S.docs)==null?void 0:j.source}}};var F,T,y;u.parameters={...u.parameters,docs:{...(F=u.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    ...Enabled.args,
    value: 'Warning',
    name: 'Warning',
...
}`,...(y=(T=u.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};var D,k,H;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    ...Enabled.args,
    value: 'Error',
    name: 'Error',
...
}`,...(M=(L=p.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};const de=["Enabled","Hover","Focus","Disabled","Success","Warning","Error","FullWidth","WithButton","WithButtonInsideText","WithButtonInsideButton"];export{o as Disabled,n as Enabled,c as Error,r as Focus,d as FullWidth,a as Hover,i as Success,u as Warning,m as WithButton,p as WithButtonInsideButton,l as WithButtonInsideText,de as __namedExportsOrder,ce as default};
