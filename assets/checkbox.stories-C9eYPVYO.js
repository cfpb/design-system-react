import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-B6lWK8m9.js";import{n,t as r}from"./checkbox-BCRp12ij.js";import{n as i,r as a,t as o}from"./checkbox.utils-B8QwnWwX.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;e((()=>{n(),a(),s=t(),{expect:c,userEvent:l,waitFor:u,within:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components (Verified)/Checkboxes/Checkbox`,tags:[`autodocs`],component:r,argTypes:{disabled:{control:`boolean`},isLarge:{control:`boolean`}},parameters:{docs:{description:{component:`Source: https://cfpb.github.io/design-system/components/checkboxes`}}}},p={render:e=>(0,s.jsx)(o,{...e}),name:`Enabled`,args:{id:`enabled`,label:`Enabled`},play:async({canvasElement:e})=>{let t=d(e);await u(()=>c(t.getByRole(`checkbox`)).not.toBeChecked()),await l.click(t.getByRole(`checkbox`)),await u(()=>c(t.getByRole(`checkbox`)).toBeChecked())}},m={render:e=>i(e),name:`Hover`,args:{id:`hover`,inputClassName:`hover`,label:`Hover`}},h={render:e=>i(e),name:`Focus`,args:{id:`focus`,inputClassName:`focus`,label:`Focus`}},g={render:e=>i(e),name:`Selected`,args:{id:`selected`,label:`Selected`,checked:!0}},_={render:e=>i(e),name:`Disabled`,args:{id:`disabled`,label:`Disabled`,checked:!1,disabled:!0},play:async({canvasElement:e})=>{let t=d(e).getByRole(`checkbox`);await l.click(t),c(t).toBeDisabled(),c(t).not.toBeChecked()}},v={render:e=>i(e),name:`Disabled/selected`,args:{id:`disabled/selected`,label:`Disabled/selected`,checked:!0,disabled:!0}},y={render:e=>i(e),name:`Success`,args:{id:`success`,label:`Success`,status:`success`}},b={render:e=>i(e),name:`Warning`,args:{id:`warning`,label:`Warning`,status:`warning`}},x={render:e=>i(e),name:`Error`,args:{id:`error`,label:`Error`,status:`error`}},S={render:e=>i(e),name:`With helper text`,args:{id:`WithHelper`,label:`Label`,helperText:`This is optional helper text`}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
