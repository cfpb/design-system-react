import{j as e}from"./index.7eca609e.js";/* empty css                */import{p as G,u as O}from"./Well.e98b5c86.js";import"./Dropdown.f396d1e9.js";import"./Checkbox.1213d1d0.js";import"./ExpandableGroup.0f5381ac.js";import"./Icon.f7c0a08e.js";import"./Paragraph.9304145b.js";import"./TextArea.7a5ccf81.js";import"./index.ca1bfdbe.js";import"./_commonjsHelpers.712cc82f.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm.1960f945.js";import"./index.f108a8f5.js";import"./iframe.2afd7431.js";import"../sb-preview/runtime.js";const m=1,j=2,w=o=>[...Array.from({length:o}).keys()].map(n=>[`A${n+m}`,`B${n+m}`]),S=o=>{const n="____PLACEHOLDER____",c=[];let t=JSON.stringify(o,(d,s)=>typeof s=="function"?(c.push(s),n):s,j);return t=t.replaceAll(new RegExp(`"${n}"`,"g"),()=>c.shift()),t},q={title:"Components (Verified)/Pagination",tags:["autodocs"],component:G},N=1,y=20,g=40,a={name:"Default pagination",args:{page:y,pageCount:g}},r={name:"Previous button disabled on first page",args:{page:N,pageCount:g}},i={name:"Next button disabled on last page",args:{page:g,pageCount:g}},p={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const t=w(6),d={rows:t,perPage:2,startPage:1},[s,P]=O(d);return e.exports.jsxs(e.exports.Fragment,{children:[e.exports.jsxs("div",{children:[e.exports.jsx("h4",{children:"Calling the hook"}),e.exports.jsxs("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: ${1},
`,`	perPage: ${2},
...
}`,...(v=(f=p.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};const z=["Base","PreviousDisabledAtMinPage","NextDisabledAtMaxPage","UsePagination"];export{a as Base,i as NextDisabledAtMaxPage,r as PreviousDisabledAtMinPage,p as UsePagination,z as __namedExportsOrder,q as default};
