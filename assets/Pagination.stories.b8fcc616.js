/* empty css                */import{P as w,u as S}from"./Well.2f0cdf92.js";import"./Dropdown.fdea2496.js";import"./Checkbox.adabeb2b.js";import"./ExpandableGroup.5d390702.js";import"./Icon.6601a6ad.js";import{a as e,F as N,j as n}from"./jsx-runtime.54133100.js";import"./Paragraph.878bd808.js";import"./index.cfa9e344.js";import"./isNativeReflectConstruct.97850bd2.js";import"./index.a2b6e612.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.c96e945c.js";import"../sb-preview/runtime.js";const m=1,y=2,C=r=>[...Array.from({length:r}).keys()].map(t=>[`A${t+m}`,`B${t+m}`]),D=r=>{const t="____PLACEHOLDER____",d=[];let a=JSON.stringify(r,(P,o)=>typeof o=="function"?(d.push(o),t):o,y);return a=a.replaceAll(new RegExp(`"${t}"`,"g"),()=>d.shift()),a},z={title:"Components (Verified)/Pagination",tags:["autodocs"],component:w},x=1,M=20,c=40,s={name:"Default pagination",args:{page:M,pageCount:c}},i={name:"Previous button disabled on first page",args:{page:x,pageCount:c}},p={name:"Next button disabled on last page",args:{page:c,pageCount:c}},g={name:"usePagination",parameters:{docs:{description:{story:"A custom hook to manage paginated data and generate props for the Pagination component. The hook internally tracks pagination state and provides event handlers to update this state."}}},render:()=>{const a=C(6),P={rows:a,perPage:2,startPage:1},[o,u]=S(P);return e(N,{children:[e("div",{children:[n("h4",{children:"Calling the hook"}),e("pre",{children:[`const [visibleRows, paginationProperties] = usePagination({
`,`	startPage: ${1},
`,`	perPage: ${2},
...
//# sourceMappingURL=Pagination.stories.b8fcc616.js.map
