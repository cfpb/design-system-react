...
`,e("code",{children:"stories/Introduction.stories.mdx"})]})})]})}}const x=()=>{throw new Error("Docs-only story")};x.parameters={docsOnly:!0};const s={title:"Example/Introduction",tags:["stories-mdx"],includeStories:["__page"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:k};const I=["__page"];export{I as __namedExportsOrder,x as __page,s as default};
//# sourceMappingURL=Introduction.stories.c6883279.js.map
