var m=Object.defineProperty;var r=(e,a)=>m(e,"name",{value:a,configurable:!0});import{b as c,j as l}from"./jsx-runtime.ae925e08.js";import"./iframe.1f90bd88.js";const g=["a-checkbox"],f=["m-form-field m-form-field__checkbox"],o=r(({id:e,name:a,helperText:s,className:i,isDisabled:p=!1,isLarge:d=!1,label:h,inputRef:b})=>{const u=[...g,i].join(" "),x=[...f,d?"m-form-field__lg-target":""].join(" ");return c("div",{className:x,children:[l("input",{id:e,type:"checkbox",name:a,className:u,ref:b,disabled:p}),c("label",{className:"a-label",htmlFor:e,children:[h,s?l("small",{className:"a-label_helper",children:s}):void 0]})]})},"Checkbox");try{o.displayName="Checkbox",o.__docgenInfo={description:"",displayName:"Checkbox",props:{id:{defaultValue:null,description:"",name:"id",required:!1,type:{name:"string"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}},helperText:{defaultValue:null,description:"",name:"helperText",required:!1,type:{name:"string"}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},isDisabled:{defaultValue:{value:"false"},description:"",name:"isDisabled",required:!1,type:{name:"boolean"}},isLarge:{defaultValue:{value:"false"},description:"",name:"isLarge",required:!1,type:{name:"boolean"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},inputRef:{defaultValue:null,description:"",name:"inputRef",required:!1,type:{name:"string | RefObject<HTMLInputElement> | ((instance: HTMLInputElement | null) => void) | null"}}}}}catch{}const D={parameters:{storySource:{source:`import type { ComponentMeta, ComponentStory } from '@storybook/react';
...
//# sourceMappingURL=Checkbox.stories.5937988f.js.map
