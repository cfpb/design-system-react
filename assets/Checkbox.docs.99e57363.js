import{r as p,j as e,a as s,F as f}from"./jsx-runtime.35eca381.js";import{M as g,a as h}from"./index.d50d5e80.js";import{C as y,D as C,a as w,L as v,b as L}from"./Checkbox.stories.2f6231bd.js";import{C as a}from"./Well.4f08619c.js";import{h as T,n as D}from"./chunk-DXNAW7Q2.a6e6e57c.js";import{u as m}from"./index.0f273fff.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.dc5fd4f4.js";import"../sb-preview/runtime.js";import"./index.e850844b.js";import"./isNativeReflectConstruct.a00d2142.js";import"./_commonjs-dynamic-modules.30ae7933.js";import"./index.6243572a.js";import"./index.ae84c53b.js";import"./extends.cc011e2f.js";import"./index.949a7f36.js";import"./_baseIsEqual.5f277acd.js";import"./assert.0ba01a32.js";import"./uniq.3b6f40f1.js";import"./index.67736049.js";import"./Dropdown.87b3265a.js";import"./Icon.43b2404a.js";import"./ExpandableGroup.8e8bf4b2.js";var H=0,M=i=>i.button===H&&!i.altKey&&!i.ctrlKey&&!i.metaKey&&!i.shiftKey,S=(i,t=o=>{})=>{M(i)&&(i.preventDefault(),t(i))},l,N=(l=class extends p.exports.PureComponent{constructor(){super(...arguments),this.state={href:"/"},this.updateHref=async()=>{let{kind:t,title:o=t,story:c,name:r=c}=this.props;if(o&&r){let n=await T(o,r);this.setState({href:n})}},this.handleClick=()=>{let{kind:t,title:o=t,story:c,name:r=c}=this.props;o&&r&&D({title:o,name:r})}}componentDidMount(){this.updateHref()}componentDidUpdate(t){let{kind:o,title:c,story:r,name:n}=this.props;(t.kind!==o||t.story!==r||t.title!==c||t.name!==n)&&this.updateHref()}render(){let{kind:t,title:o=t,story:c,name:r=c,children:n,...u}=this.props,{href:k}=this.state;return e("a",{href:k,onClick:x=>S(x,this.handleClick),...u,children:n})}},(()=>{l.defaultProps={children:void 0}})(),l),d=N;function b(i){const t=Object.assign({h1:"h1",p:"p",a:"a",h2:"h2",h3:"h3",ul:"ul",li:"li"},m(),i.components);return s(f,{children:[e(g,{of:y,name:"Overview"}),`
...
`,e(t.p,{children:"To optimize screen reader accessibility, lay out checkboxes vertically rather than horizontally."})]})}function ee(i={}){const{wrapper:t}=Object.assign({},m(),i.components);return t?e(t,Object.assign({},i,{children:e(b,i)})):b(i)}export{ee as default};
//# sourceMappingURL=Checkbox.docs.99e57363.js.map
