var y=Object.defineProperty;var a=(n,o)=>y(n,"name",{value:o,configurable:!0});import{I as u,c as N}from"./Icon.5903cde6.js";import{j as e,b as c,r as _}from"./jsx-runtime.ae925e08.js";import"./iframe.1f90bd88.js";const d=a(({href:n,label:o,isExternal:r})=>e("li",{className:"m-list_item",children:c("a",{className:"m-list_link",href:n,children:[o," ",r&&e(u,{name:"external-link"})]})}),"NotificationLink");try{d.displayName="NotificationLink",d.__docgenInfo={description:"",displayName:"NotificationLink",props:{href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},isExternal:{defaultValue:null,description:"",name:"isExternal",required:!1,type:{name:"boolean"}}}}}catch{}const s=a(({children:n,className:o,headingLevel:r="h4",links:l,message:p,type:t="info",...g})=>{const h=N("m-notification","m-notification__visible",{"m-notification__success":t==="success","m-notification__warning":t==="warning","m-notification__error":t==="error","m-notification__info":t==="info"},o);return c("div",{className:h,"data-testid":"notification",...g,children:[e(u,{...x[t]||{}}),c("div",{className:"m-notification_content",children:[p?e("p",{className:`${r} m-notification_message`,children:p}):null,n?e("p",{className:"m-notification_explanation",children:n}):null,l&&l.length>0?e("ul",{className:"m-list m-list__links",children:l.map(f=>_.exports.createElement(d,{...f,key:f.href}))}):null]})]})},"Notification"),x={error:{name:"error",withBg:!0},info:{name:"information",withBg:!0},loading:{name:"updating",withBg:!1},success:{name:"approved",withBg:!0},warning:{name:"warning",withBg:!0}};try{s.displayName="Notification",s.__docgenInfo={description:`CFPB DS Notification
