import{r as x,j as e,a as l,F as p}from"./jsx-runtime.54133100.js";import{M as f,a as s}from"./index.7d03269f.js";import{C as g,D as y,a as C,L as w,b as v}from"./Checkbox.stories.a69eed29.js";import{C as a}from"./Well.eb436ab0.js";import{h as L,n as D}from"./chunk-DXNAW7Q2.3c98b178.js";import{u as d}from"./index.daeded7c.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.91ec8672.js";import"../sb-preview/runtime.js";import"./chunk-6P7RB4HF.3102393f.js";import"./isNativeReflectConstruct.c66bbbb3.js";import"./index.a2b6e612.js";import"./index.ae84c53b.js";import"./extends.cc011e2f.js";import"./index.0d5a8cb7.js";import"./_baseIsEqual.a652f15c.js";import"./uniq.1538566d.js";import"./index.67736049.js";import"./Dropdown.381dca89.js";import"./Icon.b26ccd46.js";import"./ExpandableGroup.677ff685.js";var T=0,H=i=>i.button===T&&!i.altKey&&!i.ctrlKey&&!i.metaKey&&!i.shiftKey,M=(i,t=o=>{})=>{H(i)&&(i.preventDefault(),t(i))},b=class extends x.exports.PureComponent{constructor(){super(...arguments),this.state={href:"/"},this.updateHref=async()=>{let{kind:i,title:t=i,story:o,name:r=o}=this.props;if(t&&r){let c=await L(t,r);this.setState({href:c})}},this.handleClick=()=>{let{kind:i,title:t=i,story:o,name:r=o}=this.props;t&&r&&D({title:t,name:r})}}componentDidMount(){this.updateHref()}componentDidUpdate(i){let{kind:t,title:o,story:r,name:c}=this.props;(i.kind!==t||i.story!==r||i.title!==o||i.name!==c)&&this.updateHref()}render(){let{kind:i,title:t=i,story:o,name:r=o,children:c,...u}=this.props,{href:m}=this.state;return e("a",{href:m,onClick:k=>M(k,this.handleClick),...u,children:c})}};b.defaultProps={children:void 0};var n=b;function h(i){const t=Object.assign({h1:"h1",p:"p",a:"a",h2:"h2",h3:"h3",ul:"ul",li:"li"},d(),i.components);return l(p,{children:[e(f,{of:g,name:"Overview"}),`
...
//# sourceMappingURL=Checkbox.docs.ece1818a.js.map
