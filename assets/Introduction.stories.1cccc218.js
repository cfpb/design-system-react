...
`,e("code",{children:"stories/Introduction.stories.mdx"})]})})]})}function b(s={}){const{wrapper:r}=Object.assign({},i(),s.components);return r?e(r,{...s,children:e(o,{...s})}):o(s)}const k=()=>{throw new Error("Docs-only story")};k.parameters={docsOnly:!0};const n={title:"Example/Introduction",tags:["stories-mdx"],includeStories:["__page"]};n.parameters=n.parameters||{};n.parameters.docs={...n.parameters.docs||{},page:b};const O=["__page"];export{O as __namedExportsOrder,k as __page,n as default};
//# sourceMappingURL=Introduction.stories.1cccc218.js.map
