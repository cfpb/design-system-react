import{j as e}from"./jsx-runtime-u17CrQMm.js";/* empty css                */import{L as n,H as m,g as u,h as c,x as h}from"./Well-B0-4zp3X.js";import"./Checkbox-bkZbx_rd.js";import"./Paragraph-DvazyV92.js";import"./TextArea-DebaAmxd.js";import"./index-6tNKdD3S.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-BAD8l0rO.js";import"./iframe-DMJy3jJj.js";const S={title:"Components (Verified)/Links",tags:["autodocs"],component:n},r={args:{href:"#",children:"Link Text"}},t={render:()=>e.jsxs("p",{children:["Here's the default ",e.jsx(n,{href:"/#",label:"inline link"})," style."]})},s={render:p=>e.jsx(n,{...p,href:"/#",isJump:!0,label:"Standalone link"})},i={name:"With icon",args:{...r.args},render:()=>e.jsxs(e.Fragment,{children:[e.jsx(m,{type:"4",children:"Inline"}),e.jsxs("p",{children:["The document icon should emphasize a link that contains a"," ",e.jsx(n,{href:r.args.href,label:"file or document",iconRight:"download"}),". The external link icon is used to emphasize a link to a"," ",e.jsx(n,{href:r.args.href,label:"non-CFPB webpage",iconRight:"external-link"}),"."]}),e.jsx(m,{type:"4",children:"Standalone"}),e.jsx("p",{children:e.jsx(n,{isJump:!0,href:"https://www.example.com",iconLeft:"left",label:"Go back"})}),e.jsx("p",{children:e.jsx(n,{isJump:!0,href:"https://www.example.com",label:"Continue",iconRight:"right"})}),e.jsx("p",{children:e.jsx(n,{isJump:!0,href:"https://www.example.com",label:"External link",iconRight:"external-link"})}),e.jsx("p",{children:e.jsx(n,{isJump:!0,href:"https://www.example.com",label:"Document or file",iconRight:"document"})})]})},a={name:"List",args:{...r.args},render:()=>e.jsxs(u,{isLinks:!0,children:[e.jsx(c,{href:"/#",label:"List item 1"}),e.jsx(c,{href:"/#",label:"List item 2"}),e.jsx(c,{href:"/#",label:"List item 3"})]})},o={args:{...r.args},render:()=>e.jsx(n,{href:"/#",type:"destructive",label:"Destructive link"})},l={name:"Link using React Router Link",parameters:{docs:{description:{story:"See [React Router Link docs](https://reactrouter.com/api/components/Link) for usage information"}}},render:()=>e.jsx(h,{children:e.jsx(n,{href:"/#",label:"Link using React Router Link",isRouterLink:!0})})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => <p>
...
}`,...l.parameters?.docs?.source}}};const D=["Inline","Standalone","WithIcon","Listlink","Destructive","LinkWithReactRouterLink"];export{o as Destructive,t as Inline,l as LinkWithReactRouterLink,a as Listlink,s as Standalone,i as WithIcon,D as __namedExportsOrder,S as default};
