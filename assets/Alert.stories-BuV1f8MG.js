import{j as e}from"./jsx-runtime-BLchON5X.js";/* empty css                */import{A as I,T as p,a as x,L as v,I as T}from"./Well-iIZHQQ7z.js";import"./Checkbox-C8PZvyyp.js";import"./Paragraph-CSOJQ8Ca.js";import"./TextArea-Ddz0oDhE.js";import"./index-kA4PVysc.js";import"./index-6tNKdD3S.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-D_VgsJHj.js";import"./iframe-BB2YN6Db.js";const _={title:"Components (Draft)/Alerts",component:I,tags:["autodocs"],argTypes:{message:{control:"text"}}},f=({status:s="a warning"})=>e.jsxs(e.Fragment,{children:["This is a field-level alert with ",s," status."," ",e.jsxs(v,{hasIcon:!0,href:window.location.host,children:["Link to more info ",e.jsx(T,{name:"external-link"})]}),"."]}),h=s=>`This is an optional explanation of the ${s} message.`,g={href:"/",label:"This is an external link",isExternal:!0},a={render:s=>e.jsx(I,{...s}),args:{status:"info",message:"A Notification"}},n={...a,name:"Information with a message and an explanation",args:{...a.args,message:"Here is the message of the notification.",children:"This is a longer explanation to demonstrate how text wrapping is applied to more extensive alert content."}},r={...a,name:"Information with only an explanation",args:{children:"You can also only have an explanation in the notification."}},t={...a,name:"Information with explanation and links",args:{...a.args,children:"This is the explanation of the notification.",links:[{href:"/",label:"This is a link below the explanation"},g]}},o={...a,args:{...a.args,status:"success",message:"11 results",links:[g],children:e.jsx(e.Fragment,{children:h("success")})}},i={...a,args:{...a.args,status:"warning",message:"No results found.",links:[g],children:e.jsx(e.Fragment,{children:h("warning")})}},l={...a,args:{...a.args,status:"error",message:"Page not found.",links:[g],children:e.jsx(e.Fragment,{children:h("error")})}},m={...a,name:"In-progress",args:{...a.args,status:"loading",message:"The page is loading…."}},c={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Success (field-level)",args:{status:"success",message:e.jsx(f,{status:"a success"})}},u={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Warning (field-level)",args:{status:"warning",message:e.jsx(f,{status:"a warning"})}},d={render:s=>e.jsxs("div",{className:"m-form-field",children:[e.jsx(p,{id:s.status,name:s.status,status:s.status,value:"Input Text",type:"text"}),e.jsx(x,{...s})]}),name:"Error (field-level)",args:{status:"error",message:e.jsx(f,{status:"an error"})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
