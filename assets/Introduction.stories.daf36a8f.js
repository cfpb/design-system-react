...
`,e("code",{children:"stories/Introduction.stories.mdx"})]})})]})}function b(s={}){const{wrapper:r}=Object.assign({},i(),s.components);return r?e(r,{...s,children:e(n,{...s})}):n(s)}const k=()=>{throw new Error("Docs-only story")};k.parameters={docsOnly:!0};const o={title:"Example/Introduction",tags:["stories-mdx"],includeStories:["__page"]};o.parameters=o.parameters||{};o.parameters.docs={...o.parameters.docs||{},page:b};const O=["__page"];export{O as __namedExportsOrder,k as __page,o as default};
//# sourceMappingURL=Introduction.stories.daf36a8f.js.map
