import{r as x,j as e,a as c,F as p}from"./jsx-runtime.5f84dc07.js";import{M as f,a as s}from"./index.9b264252.js";import{C as g,D as y,a as C,L as w,b as v}from"./Checkbox.stories.56de347f.js";import{C as a}from"./Well.2db23307.js";import{h as L,n as T}from"./chunk-DXNAW7Q2.a6e6e57c.js";import{u as d}from"./index.45a0dfff.js";import"./_commonjsHelpers.712cc82f.js";import"./iframe.1de0cd5f.js";import"../sb-preview/runtime.js";import"./index.e850844b.js";import"./floating-ui.dom.esm.1a703617.js";import"./index.40d0d0b8.js";import"./index.ae84c53b.js";import"./extends.cc011e2f.js";import"./index.0cd5de07.js";import"./_baseIsEqual.5f277acd.js";import"./uniq.3b6f40f1.js";import"./index.67736049.js";import"./Dropdown.2b540f0c.js";import"./Icon.1313dab3.js";import"./ExpandableGroup.78261938.js";var D=0,H=i=>i.button===D&&!i.altKey&&!i.ctrlKey&&!i.metaKey&&!i.shiftKey,M=(i,t=o=>{})=>{H(i)&&(i.preventDefault(),t(i))},b=class extends x.exports.PureComponent{constructor(){super(...arguments),this.state={href:"/"},this.updateHref=async()=>{let{kind:i,title:t=i,story:o,name:r=o}=this.props;if(t&&r){let n=await L(t,r);this.setState({href:n})}},this.handleClick=()=>{let{kind:i,title:t=i,story:o,name:r=o}=this.props;t&&r&&T({title:t,name:r})}}componentDidMount(){this.updateHref()}componentDidUpdate(i){let{kind:t,title:o,story:r,name:n}=this.props;(i.kind!==t||i.story!==r||i.title!==o||i.name!==n)&&this.updateHref()}render(){let{kind:i,title:t=i,story:o,name:r=o,children:n,...u}=this.props,{href:m}=this.state;return e("a",{href:m,onClick:k=>M(k,this.handleClick),...u,children:n})}};b.defaultProps={children:void 0};var l=b;function h(i){const t=Object.assign({h1:"h1",p:"p",a:"a",h2:"h2",h3:"h3",ul:"ul",li:"li"},d(),i.components);return c(p,{children:[e(f,{of:g,name:"Overview"}),`
...
//# sourceMappingURL=Checkbox.docs.8915f4ba.js.map
