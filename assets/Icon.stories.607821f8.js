import{I as a}from"./Icon.4b524adb.js";import{j as e,F as h,a as t}from"./jsx-runtime.556016cd.js";import"./index.cfa9e344.js";import"./iframe.62fe0d92.js";import"../sb-preview/runtime.mjs";import"./_commonjsHelpers.712cc82f.js";const _={component:a,parameters:{docs:{description:{component:`
### CFPB DS Icon component

Source: https://cfpb.github.io/design-system/foundation/iconography
`}}}},m=n=>n.map((d,l)=>e(h,{children:t("tr",{children:[e("td",{children:e(a,{name:d},l)}),e("td",{children:e(a,{name:d,withBg:!0},l)}),e("td",{children:d})]})})),r=()=>e(h,{children:e(a,{name:"approved"})}),o=()=>e(h,{children:e(a,{name:"approved",withBg:!0})}),c=()=>{const n=["approved","error","warning","update","updating"];return t("table",{children:[t("thead",{children:[e("th",{children:"icon"}),e("th",{children:"withBg"}),e("th",{children:"canonical name"})]}),e("tbody",{children:m(n)})]})},s=()=>{const n=["information","external-link"];return t("table",{children:[t("thead",{children:[e("th",{children:"icon"}),e("th",{children:"withBg"}),e("th",{children:"canonical name"})]}),e("tbody",{children:m(n)})]})},i=()=>{const n=["up","right","down","left"];return t("table",{children:[t("thead",{children:[e("th",{children:"icon"}),e("th",{children:"withBg"}),e("th",{children:"canonical name"})]}),e("tbody",{children:m(n)})]})};var p,u,g;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`(): React.ReactElement => <>
    <Icon name='approved' />
...
//# sourceMappingURL=Icon.stories.607821f8.js.map
