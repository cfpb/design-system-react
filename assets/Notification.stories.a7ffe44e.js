import{c as O}from"./index.cfa9e344.js";import{I as F}from"./Icon.4ca78e8b.js";import{j as a,a as f,r as R}from"./jsx-runtime.556016cd.js";import"./iframe.124735d7.js";import"../sb-preview/runtime.mjs";import"./_commonjsHelpers.712cc82f.js";const g=({href:n,label:p,isExternal:u})=>a("li",{className:"m-list_item",children:f("a",{className:"m-list_link",href:n,children:[p," ",u&&a(F,{name:"external-link"})]})});try{g.displayName="NotificationLink",g.__docgenInfo={description:"",displayName:"NotificationLink",props:{href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},isExternal:{defaultValue:null,description:"",name:"isExternal",required:!1,type:{name:"boolean"}}}}}catch{}const m=({children:n,className:p,headingLevel:u="h4",links:d,message:h,type:r="info",...Y})=>{const $=O("m-notification","m-notification__visible",{"m-notification__success":r==="success","m-notification__warning":r==="warning","m-notification__error":r==="error","m-notification__info":r==="info"},p);return f("div",{className:$,"data-testid":"notification",...Y,children:[a(F,{...z[r]||{}}),f("div",{className:"m-notification_content",children:[h?a("p",{className:`${u} m-notification_message`,children:h}):null,n?a("p",{className:"m-notification_explanation",children:n}):null,d&&d.length>0?a("ul",{className:"m-list m-list__links",children:d.map(_=>R.exports.createElement(g,{..._,key:_.href}))}):null]})]})},z={error:{name:"error",withBg:!0},info:{name:"information",withBg:!0},loading:{name:"updating",withBg:!1},success:{name:"approved",withBg:!0},warning:{name:"warning",withBg:!0}};try{m.displayName="Notification",m.__docgenInfo={description:`CFPB DS Notification
...
//# sourceMappingURL=Notification.stories.a7ffe44e.js.map
