import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{i as n,n as r,r as i,t as a}from"./expandable-group-ClbGeRsb.js";async function o(e){return new Promise(t=>{setTimeout(t,e)})}function s(){return(s=e((()=>{try{o.displayName=`sleep`,o.__docgenInfo={description:``,displayName:`sleep`,filePath:`/home/runner/work/design-system-react/design-system-react/src/utils/sleep.tsx`,methods:[],props:{},tags:{}}}catch{}})))()}var c,l,u,d,f,p,m,h,g,_,v,y,b,x;function S(){return(S=e((()=>{n(),s(),r(),c=t(),{expect:l,userEvent:u,waitFor:d,within:f}=__STORYBOOK_MODULE_TEST__,p={title:`Components (Verified)/Expandables`,component:i,tags:[`autodocs`],parameters:{docs:{description:{component:`
...
`}}}},m=(0,c.jsxs)(`p`,{children:[`Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque ipsa voluptatibus soluta nobis unde quisquam temporibus magnam debitis quidem. Ducimus ratione corporis nesciunt earum vel est quaerat blanditiis dolore ipsa?\xA0`,(0,c.jsx)(`a`,{href:`./?path=/story/components-expandable--default`,children:`Lorem link`})]}),h=({accordion:e})=>(0,c.jsxs)(`p`,{children:[`Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque ipsa voluptatibus soluta nobis unde quisquam temporibus magnam debitis quidem. Ducimus ratione corporis nesciunt earum vel est quaerat blanditiis dolore ipsa?\xA0`,(0,c.jsx)(`a`,{href:`./?path=/story/components-expandablegroup--${e?`accordion`:`default`}`,children:`Lorem link`})]}),g={name:`Single`,args:{header:`Expandable label`,children:m}},_={name:`Padded`,args:{...g.args,header:`Expandable label`,isPadded:!0}},v={name:`Open on load`,args:{...g.args,header:`Expandable label`,openOnLoad:!0}},y={name:`Group`,render:e=>(0,c.jsx)(a,{...e,children:[`label`,`label`,`label`].map((t,n)=>(0,c.jsx)(i,{header:`Expandable ${t}`,inAccordion:e.accordion,children:(0,c.jsx)(h,{accordion:e.accordion})},`item-${t}-${n}`))}),play:async({canvasElement:e,step:t})=>{let n=1e3,r={timeout:n},i=(await f(e).findAllByTitle(`Expandable label`))[0],a=e=>{l(i.ariaExpanded).toBe(e)};await t(`Starts out collapsed`,async()=>{await d(()=>a(`false`),r)}),await t(`Click to expanded`,async()=>{await u.click(i),await d(()=>a(`true`),r),await o(n)}),await t(`Click to collapse`,async()=>{await u.click(i),await d(()=>a(`false`),r)})},args:{groupId:`DefaultGroup`}},b={...y,args:{accordion:!0,groupId:`AccordionGroup`}},x=[`Default`,`PaddedExpandable`,`OpenOnLoad`,`DefaultExpandableGroup`,`Accordion`],g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  ...
  name: 'Group',
  render: (arguments_: ExpandableGroupArguments) => <ExpandableGroup {...arguments_}>
...
}`,...b.parameters?.docs?.source}}}})))()}S();export{b as Accordion,g as Default,y as DefaultExpandableGroup,v as OpenOnLoad,_ as PaddedExpandable,x as __namedExportsOrder,p as default};